...
researcher = Agent(
    ...
    goal="""
    1. Conduct deep research on the given  company : {company}.
    2. Identify key business areas (supply chain, customer experience, automation).
    3. Extract insights from industry reports (McKinsey, Deloitte, Gartner).
    4. Summarize market trends and competitive landscape.
    """,
    backstory="""
    Former business strategist specializing in AI-driven market research. 
    Expert in analyzing financial reports, customer behavior, and automation trends.
    Uses AI-powered web scraping and trend forecasting to generate insights.
    """,
    memory=True,
    verbose=True,
    llm=llm,
...
use_case_generator = Agent(
    ...
    goal="""
    1. Analyze AI/ML/GenAI trends in the  company : {company}.
    2. Generate high-impact AI use cases (e.g., chatbots, predictive analytics).
    3. Recommend GenAI solutions (automated reports, AI search).
    """,
    backstory="""
    AI consultant with 10+ years of experience in deploying enterprise AI solutions.
    Specializes in LLMs, automation, and data-driven decision-making.
    """,
    memory=True,
    verbose=True,
    llm=llm,
...
resource_collector = Agent(
    role="Data & AI Asset Curator",
    goal="""
    1. Find datasets (Kaggle, Hugging Face) for proposed AI use cases for company : {company}.
    2. Collect AI models, tools, and GitHub repos.
    3. Save clickable resource links in Markdown.
    """,
    backstory="""
    Data engineer specializing in AI/ML datasets and open-source tools.
    Maintains a repository of 500+ industry-specific datasets.
    """,
    memory=True,
    verbose=True,
    llm=llm,
...
proposal_writer = Agent(
    role="Business AI Strategist",
    goal="""
    1. Compile top AI use cases with business justification for company : {company}.
    2. Ensure alignment with company strategy.
    3. Format into a professional proposal with references.
    """,
    backstory="""
    Ex-management consultant with expertise in AI adoption strategies.
    Helps enterprises integrate AI into operations and customer experience.
    """,
    memory=True,
    verbose=True,
    llm=llm,
